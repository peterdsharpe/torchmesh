...
class TestCacheIsolation:
    ...
    def test_user_point_data_is_preserved(self):
        ...
        point_data = {
            ...
            "velocity": torch.tensor([[1.0, 0.0, 0.0], [1.0, 0.5, 0.0], [1.0, 0.25, 0.0]]),
        }
        ...
        assert torch.equal(edge_mesh.point_data["temperature"], point_data["temperature"])
    ...
    def test_multiple_cache_types_filtered(self):
        ...
        assert torch.equal(
            edge_mesh.point_data["user_field"],
            mesh.point_data["user_field"]
        )
