...
def perlin_noise_nd(points: torch.Tensor, scale: float = 1.0, seed: int = 0) -> torch.Tensor:
    ...
    interp_weights = fractional_coords * fractional_coords * fractional_coords * (
...
def perlin_noise_1d(points: torch.Tensor, scale: float = 1.0, seed: int = 0) -> torch.Tensor:
    """1D Perlin noise.
...
def perlin_noise_2d(points: torch.Tensor, scale: float = 1.0, seed: int = 0) -> torch.Tensor:
    """2D Perlin noise.
