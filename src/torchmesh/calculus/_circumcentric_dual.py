...
def compute_dual_volumes_0(mesh: "Mesh") -> torch.Tensor:
    ...
    if mesh.n_manifold_dims == 2:
        ...
        dual_volumes = torch.zeros(mesh.n_points, dtype=mesh.points.dtype, device=mesh.points.device)
...
def compute_cotan_weights_triangle_mesh(mesh: "Mesh") -> tuple[torch.Tensor, torch.Tensor]:
